...
<section id="supportWrap">
    ...
    <div class="innerWrap">
        ...
        <div class="textWrap">
            ...
            <p class="animate-bottom">1998年から栃木・福島・群馬・埼玉の4会場で毎年数百名のお客様が参加しています。鉄鋼メーカーで薄鋼板の成形・利用技術に関する研究に幅広く携わってきた技術顧問が、鉄鋼薄板製品、塑性力学、塑性加工、新工法・新技術などの分野で、基礎技術から応用技術まで、広範囲にわたった講演を行っています。<br>また、この講習会では鉄鋼事情の最新情報を発信するとともに、普段なかなか機会が無い鉄鋼メーカーとお客様が顔を会わせることのできる場として、 鉄鋼業界の活性化の役割も果たしています。</p>
        </div>
    </div>
</section>
<!--
