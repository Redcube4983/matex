...
<section id="supportWrap">
    ...
    <div class="innerWrap">
        ...
        <div class="textWrap">
            ...
            <p class="animate-bottom">鉄のことを知り尽くしたマテックスの技術顧問がお客様のもとへお伺いし、不良品発生のお悩みや、加工技術の問題点などについての丁寧にヒアリングし、改善策、解決策をご提案しています。</p>
        </div>
    </div>
    <div class="innerWrap">
        <div class="img animate-bottom">
        ...
        <div class="textWrap">
            ...
            <p class="animate-bottom">1998年から毎年、栃木・福島・群馬・埼玉の4会場で開催し、毎回数百名のお客様が参加されています。鉄鋼メーカーで薄鋼板の成形・利用技術に関する研究に幅広く携わってきたマテックスの技術顧問が、鉄鋼薄板製品、塑性力学、塑性加工、新工法・新技術などの分野で、基礎技術から応用技術まで、広範囲にわたった講演を行っています。<br>また、この講習会では鉄鋼事情の最新情報を発信するとともに、普段なかなか機会が無い鉄鋼メーカーとお客様が顔を会わせることのできる場として、 鉄鋼業界の活性化の役割も果たしています。</p>
        </div>
    </div>
</section>
