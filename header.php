...
<header id="headerWrap">
    ...
    <ul id="global-nav">
        ...
        <li class="global-nav parent">
            <h3><a class="gNavColor" href="<?php echo get_template_directory_uri(); ?>/aboutus/">企業情報</a><div class="arrow"><div></div></div></h3>
            <ul class="child">
        ...
        <li class="global-nav parent">
            <h3><a class="gNavColor" href="/business/">事業情報</a><div class="arrow"><div></div></div></h3>
            <ul class="child">
        ...
        <li class="global-nav parent">
            <h3><a class="gNavColor" href="/recruit/">採用情報</a><div class="arrow"><div></div></div></h3>
            <ul class="child">
