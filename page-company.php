...
<section id="companyWrap">
    <div class="textWrap">
        ...
        <p class="animate-bottom">「鉄」は古来から日本刀に使われ、その実用性、加工性、芸術性の高さから海外でも高く評価されました。戦後は「産業のコメ」と呼ばれ、あらゆる分野の基礎素材として復興を助け、高度経済成長期には東京タワーや高速道路、高層ビルなどに使用され経済発展に大きく寄与しました。日本の鉄鋼製品は、加工性がよく、丈夫で経済的であり、また、鉄スクラップは不純物をとり除くことでリサイクルされ、再び別の製品に生まれ変われることができる環境に優しい素材です。マテックスが扱う「鉄」は、今もなお研究開発され、次世代の暮らしや産業に欠かせない無限の可能性を秘めたマテリアル(素材)なのです。</p>
    </div>
    <div class="imgWrap">
    ...
    <div class="textWrap2">
        ...
        <p class="animate-bottom">鉄鋼メーカーや製品メーカーだけでは、私たちの生活や産業は成り立ちません。鉄鋼メーカーとユーザー(製品メーカー、部品メーカー)の中間に立ち、鉄鋼メーカーが製造する母材を(商社などを経由して)仕入れ、ユーザーの仕様デマンドにあわせて加工するコイルセンターの存在が不可欠です。マテックスは、関東・東北を中心に展開するコイルセンターとして、高度なコイル加工技術と新鋭機器を駆使し、厳しい品質管理体制のもとに高品質・高精度の鋼材をユーザーにお届けしています。社会と鉄の架け橋としてーマテックスは鉄鋼流通の要となる重要な役割を担っているのです。</p>
