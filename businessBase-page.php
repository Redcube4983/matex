...
<section id="leadWrap">
        ...
        <p class="textCenter">東京本社を中心に、関東から東北にかけて、生産と販売サービスを一体化した拠点をバランスよく展開。<br class="tab pc pc2">お客様のさまざまなニーズにタイムリーにお応えできる体制を整えています。</p>
</section>
<section id="base">
    <ul class="baseInner">
        <li>
            ...
            <div class="mapWrap">
                ...
                <div class="addressWrap">
                    ...
                    <span class="number">Tel. 03-3844-0808　Fax. 03-3844-4109</span>
                </div>
            </div>
        </li>
        <li>
