    ...
    <div class="topTtlInner">
        <div class="topImg">
            <picture class="">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/images/aboutus/profile/profile-top-sp.jpg" srcset="<?php echo get_template_directory_uri(); ?>/images/aboutus/profile/profile-top-pc.webp 1x,<?php echo get_template_directory_uri(); ?>/images/aboutus/profile/profile-top-pc.webp 2x" alt="トップ背景画像">
                </picture>
        </div>
        <div class="ttlWrap">
