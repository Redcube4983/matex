...
<main id="mainWrap">
    <section class="leadWrap">
        ...
        <p class="aboutLead">私たちは長い間技術を蓄積し、さまざまな面で合理化を重ねてまいりましたが、その目的はただひとつ、「お客様にご満足をいただく」ことです。マテックスの社員教育の根幹は、お客様最優先の意識の徹底です。私たちは社内外におけるあらゆる活動、決定を「どうすればお客様にご満足いただけるか」という一点に絞って対処してきました。創業以来、激動の年月を着実に成長し続けることができましたのも、この単純明快な信念に徹してきたことで、長くお客様の信頼をかち得たからだと信じています。<br>マテックスはこれからもこの信念を曲げることなく、新しい時代に立ち向かってまいります。</p>
    </section>
