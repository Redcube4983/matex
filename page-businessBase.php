...
<div id="main-visual">
    <div class="topTtlInner">
        <div class="topImg">
            <picture class="">
                    <source media="(max-width: 767px)" srcset="<?php echo get_template_directory_uri(); ?>/images/businessBase/businessBase-top-sp.jpg 1x,<?php echo get_template_directory_uri(); ?>/images/businessBase/businessBase-top-sp.jpg 2x">
                    <source media="(max-width: 920px)" srcset="<?php echo get_template_directory_uri(); ?>/images/businessBase/businessBase-top-pc.jpg 1x,<?php echo get_template_directory_uri(); ?>/images/businessBase/businessBase-top-pc.jpg 2x">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/businessBase/businessBase-top-sp.jpg" srcset="<?php echo get_template_directory_uri(); ?>/images/businessBase/businessBase-top-pc.jpg 1x,<?php echo get_template_directory_uri(); ?>/images/businessBase/businessBase-top-pc.jpg 2x" alt="トップ背景画像">
                </picture>
        </div>
        <div class="ttlWrap">
...
<section id="leadWrap">
        ...
        <p class="textCenter">東京本社を中心に、関東から東北にかけて、生産と販売サービスを一体化した拠点をバランスよく展開。<br class="pc">お客様のさまざまなニーズにタイムリーにお応えできる体制を整えています。</p>
</section>
<section id="base">
    <ul class="baseInner">
        <li>
